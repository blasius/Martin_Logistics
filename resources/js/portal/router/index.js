    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                { path: "hr/employees/create", component: () => import("../pages/Hr/Employees/Create.vue") },
                { path: "hr/employees/:id", component: () => import("../pages/Hr/Employees/Show.vue") },
                { path: "hr/leave", component: () => import("../pages/Hr/Leave/Index.vue") },
                { path: "hr/attendance", component: () => import("../pages/Hr/Attendance/Index.vue") },
                { path: "hr/attendance/clock", component: () => import("../pages/Hr/Attendance/Clock.vue") },
                { path: "hr/payroll", component: () => import("../pages/Hr/Payroll/Index.vue") },
                // Accounting & GL (Phase 9)
                { path: "accounting/chart-of-accounts", component: () => import("../pages/Accounting/ChartOfAccounts/Index.vue") },
                { path: "accounting/journal-entries", component: () => import("../pages/Accounting/JournalEntries/Index.vue") },
                { path: "accounting/journal-entries/create", component: () => import("../pages/Accounting/JournalEntries/Create.vue") },
                { path: "accounting/journal-entries/:id", name: "accounting.journal-entries.show", component: () => import("../pages/Accounting/JournalEntries/Show.vue"), props: true },
