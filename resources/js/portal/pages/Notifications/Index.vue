    ...
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Stay updated on orders, invoices, and deliveries</p>
            </div>
        ...
        <div v-else class="space-y-2">
            <div v-for="n in notifications" :key="n.id"
                ...
                :class="{ 'border-l-4 border-l-orange-500 bg-orange-50/30': !n.read_at, 'border-l-4 border-l-transparent': !!n.read_at }">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                        <span v-if="!n.read_at" class="w-2 h-2 bg-orange-500 rounded-full"></span>
                        <button @click.stop="deleteNotification(n)" class="p-1 hover:bg-slate-100 rounded transition-colors">
                            <Trash2 class="w-4 h-4 text-slate-300 hover:text-red-500" />
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div v-if="hasMore" class="mt-6 text-center">
            <button @click="loadMore" :disabled="loadingMore"
                class="text-sm text-orange-600 hover:text-orange-700 font-medium px-6 py-2 rounded-lg border border-orange-200 hover:bg-orange-50 transition-colors">
...
import { Bell, Package, FileText, CheckCircle, Trash2 } from 'lucide-vue-next';
